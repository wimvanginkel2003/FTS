<x-app-layout>
    ...
    <div class=" mt-4 m-2 p-6 mb-6 bg-white shadow-md rounded-2xl text-xl font-bold text-indigo-900">
        <h2>Jouw busreis naar: We Love Green</h2>
    </div>
    ...
    <div class="mt-4 m-2 p-6 mb-6 bg-white shadow-md rounded-2xl ">
        ...
        <p class="text-indigo-900">Voor de terugreis vertrek je vanaf We Love Green P1, de parkeerplaats dicht bij de hoofdingang van het festival. Het is ongeveer 20 minuten lopen van de ingang naar de opstaplocatie.
        </p>
