<x-app-layout>
    ...
    <div class="font-bold m-4 mt-2  sm:w-2/3 flex justify-end">
        <x-nav-link class="mt-4 sm:text-4xl text-red-600"  :href="route('creëerbeheerder')" :active="request()->routeIs('creëerbeheerder')">
            {{ __('Create page') }}
        </x-nav-link>
    </div>
    ...
    <div class="mt-4 m-4 p-6 mb-6 bg-white shadow-md rounded-2xl text-indigo-900 sm:w-2/3 ">
        ...
        <div class="flex justify-between">
            ...
            <x-nav-link @class("mb-2 mt-6") :href="route('editbeheerder')" :active="request()->routeIs('editbeheerder')">
                {{ __('Edit') }}
            </x-nav-link>
